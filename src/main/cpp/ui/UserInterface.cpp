...
namespace SwerveDriveUI {
    ...
    // Steer encoders
    nt::GenericEntry *const nt_left_front_front_steer = nt_tab.Add("left front steer", 0).GetEntry();
    nt::GenericEntry *const nt_left_back_front_steer = nt_tab.Add("left back steer", 0).GetEntry();
    nt::GenericEntry *const nt_right_front_front_steer = nt_tab.Add("right front steer", 0).GetEntry();
    nt::GenericEntry *const nt_right_back_front_steer = nt_tab.Add("right back steer", 0).GetEntry();
